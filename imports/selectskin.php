                ...
                switch($selectedweapon_type) {
                    case 'gloves':
                        foreach($gloves as $glove) {
                            ...
                            ?>
                            <li>
                                <button class='card <?= (is_array($saved_t) && isset($saved_t['weapon_defindex']) && $saved_t['weapon_defindex'] == $glove->weapon_defindex && $current_t->paint == $glove->paint) || (is_array($saved_ct) && isset($saved_ct['weapon_defindex']) && $saved_ct['weapon_defindex'] == $glove->weapon_defindex && $current_ct->paint == $glove->paint)?'selected':''; ?>' data-action='weapon_change' data-weapon='<?= $selectedweapon; ?>' data-defindex='<?= $glove->weapon_defindex; ?>' data-paint='<?= $glove->paint == '0' ?'default':$glove->paint; ?>'>
                                    <div class="imgbox">
...
<footer>
    <div class="wrapper">
        ...
        <div class="credit">
            <p>This website created by Zennji</p>
        </div>
        <div class="actions">
            <div class="settings">
